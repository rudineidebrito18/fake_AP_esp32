...
#define POST_BODY "Sua conta está sendo validada. Por favor, aguarde até 5 minutos para a conexão do dispositivo.</br>Obrigado."
...
String header(String t) {
  ...
  String CSS = "article { background: #f2f2f2; padding: 1.3em; }" 
    ...
    "nav { background:" + colorPrimary + "; color: #fff; display: block; font-size: 1.3em; padding: 1em; }"
